...
build_vf_woff2 "regular" "$BUILD_VF_DIR/ChironGoRoundTCVF.otf" $BUILD_WOFF2_OTF_DIR "vf"
build_vf_woff2 "regular" "$BUILD_VF_DIR/ChironGoRoundTCVF.ttf" $BUILD_WOFF2_TTF_DIR "vf"
