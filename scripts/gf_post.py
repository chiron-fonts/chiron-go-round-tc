...
font["name"].setName("Copyright 2025 The Chiron GoRound TC Project Authors (https://github.com/chiron-fonts/chiron-go-round-tc)",0,3,1,1033)
font["name"].setName("ChironGoRoundTC-ExtraLight",6,3,1,1033)
...
newPath = str(file).replace("variable/","")
font.save(newPath)